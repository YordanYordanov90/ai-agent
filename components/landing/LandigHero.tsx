            ...
            <div className="lg:col-span-7 space-y-8 animate-fade-up">
              ...
              <div className="space-y-4">
                <h1 className="font-heading text-6xl sm:text-7xl lg:text-8xl tracking-tighter text-white leading-[0.9] uppercase font-black">
                  Execute<br/>
                  <span className="text-emerald-500 relative inline-block animate-pulse-glow">
                    Code
                  </span>
                  <br/>
                  In Discord
              ...
              <p className="text-xl text-zinc-400 max-w-lg font-mono leading-relaxed">
                &gt; Cody is a command-line interface wrapped in a Discord bot. Ship Next.js PRs, fetch market data, execute strategy.
              </p>
              ...
              <div className="relative bg-black border border-zinc-800 shadow-2xl p-1 animate-float-y">
                <div className="bg-zinc-950 p-6 font-mono text-xs md:text-sm text-emerald-400/80 leading-relaxed overflow-hidden h-[400px]">
                  ...
                  <div className="space-y-3 opacity-80">
                    <p><span className="text-zinc-500">01</span> $ ssh cody@discord -p 443</p>
                    <p><span className="text-zinc-500">02</span> Authenticating with xAI Core...</p>
                    <p><span className="text-zinc-500">03</span> <span className="text-blue-400">SUCCESS</span> Models synchronized.</p>
                    <p className="pt-2"><span className="text-zinc-500">04</span> $ cody create-auth --stack nextjs</p>
                    <p><span className="text-zinc-500">05</span> Analyzing repository structure...</p>
                    <p><span className="text-zinc-500">06</span> Scaffolding Zod schemas & Server Actions.</p>
                    <p><span className="text-zinc-500">07</span> Pushing branch <span className="text-purple-400">feature/auth-v2</span></p>
                    <p className="pt-2"><span className="text-zinc-500">08</span> <span className="text-emerald-500">PR #42 OPENED</span> Waiting for Human-in-the-Loop</p>
